...
cr_p = re.compile(r'\(([0-9a-f]{4}):([0-9a-f]{2}):([0-9a-f]{2})\.([0-9a-f]{1}), \@(0x[0-9a-f]{1,4}), len=(0x[0-9a-f])\)\s([0-9a-f]{1,8})\s*')
cw_p = re.compile(r'\(([0-9a-f]{4}):([0-9a-f]{2}):([0-9a-f]{2})\.([0-9a-f]{1}), \@(0x[0-9a-f]{1,4}), (0x[0-9a-f]{1,8}), len=(0x[0-9a-f])\)\s*')
rr_p = re.compile(r'\(([0-9a-f]{4}):([0-9a-f]{2}):([0-9a-f]{2})\.([0-9a-f]{1}):(region[0-9]{1})\+(0x[0-9a-f]{1,4}), (\d*)\) = (0x[0-9a-f]{1,8})\s*')
rw_p = re.compile(r'\(([0-9a-f]{4}):([0-9a-f]{2}):([0-9a-f]{2})\.([0-9a-f]{1}):(region[0-9]{1})\+(0x[0-9a-f]{1,4}), (0x[0-9a-f]{1,8}), (\d*)\)\s*')
